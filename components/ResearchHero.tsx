...
const STATS = [
  { num: '3',           label: 'JNTUH Research Centres',    accent: 'from-[#1F6B24] to-[#3aa050]' },
  { num: '2019',        label: 'IPFC Established',           accent: 'from-[#c26a2b] to-[#e08a3a]' },
  { num: '25+',         label: 'Doctoral Faculty',           accent: 'from-[#1F6B24] to-[#46b85f]' },
  { num: '2016 – 2025', label: 'Peer-reviewed Publications', accent: 'from-[#c26a2b] to-[#f2b56b]' },
];
    ...
    <section className="relative overflow-hidden bg-green-hero text-white">
      ...
      <div className="relative w-full px-8 md:px-12 lg:px-16 py-20 md:py-24 lg:py-28">
        ...
        >
          {title}
          {italic && (
            <span className="block font-display italic font-medium mt-2" style={{
        ...
        >
          {STATS.map((s, i) => (
            ...
            >
              <div
                aria-hidden
                className={`absolute inset-0 opacity-0 group-hover:opacity-30 transition-opacity duration-500 bg-gradient-to-br ${s.accent}`}
              />
