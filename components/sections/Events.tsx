...
const SLIDES: Slide[] = [
  ...
  },
  {
    ...
    title: 'Zignasa 2025',
    desc:  'Zignasa is MLRIT\'s five-day inter-departmental fest — hackathons, robotics arenas, coding contests, music, dance and film screenings running simultaneously. Every department competes. Every stage is open.',
    quote: 'Five days. Every department on stage. Zignasa is the event that turns the whole campus into one team.',
    speaker: 'Zignasa',
  ...
  },
  {
    ...
    title: 'Zenith 2K25',
    desc:  'Zenith is MLRIT\'s national-level technical festival — colleges from across India compete in robotics, circuit design, coding sprints and product challenges across three days. Open registrations, multi-college participation.',
    quote: 'National-level. Multi-college. Three days of engineering at full intensity — Zenith is where MLRIT competes with the country.',
    speaker: 'Zenith',
  ...
  },
  {
    logo:  '/assets/logo.svg',
    alt:   'CAME 2K25',
    tag:   'Aerospace · Mechanical · 2025',
    title: 'CAME 2K25',
    desc:  'CAME — Conference on Aerospace and Mechanical Engineering — is MLRIT\'s student-research conference for the AE and MECH departments. Students present papers, attend industry talks and participate in UAV and drone demonstrations.',
    quote: 'Student papers. Industry panels. UAV demos. CAME is the one event where AE and MECH students show the depth of their research.',
    speaker: 'CAME',
    speakerRole: 'AE · MECH · MLRIT',
