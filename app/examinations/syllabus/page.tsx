...
const SUBJECTS: Record<SubjectKey, Subject[]> = {
  ...
  // ════════════════════════════════════════════
  'ECE-R22-1-1': [
    { code: 'BS101', name: 'Mathematics-I',                               type: 'Theory',    credits: 4 },
    { code: 'BS102', name: 'Applied Physics',                             type: 'Theory',    credits: 4 },
    { code: 'ES101', name: 'Programming for Problem Solving',             type: 'Theory',    credits: 3 },
    { code: 'ES102', name: 'Engineering Drawing',                         type: 'Theory',    credits: 3 },
    { code: 'HS101L', name: 'English Communication Skills Lab',           type: 'Lab',       credits: 1 },
    { code: 'ES101L', name: 'Programming Lab',                            type: 'Lab',       credits: 1 },
    { code: 'BS102L', name: 'Physics Lab',                                type: 'Lab',       credits: 1 },
    { code: 'MC101', name: 'Mandatory Induction',                         type: 'Mandatory', credits: 0 },
  ],
  'ECE-R22-1-2': [
    { code: 'BS201', name: 'Engineering Chemistry',                       type: 'Theory',    credits: 4 },
    { code: 'HS201L', name: 'Advanced Communication Skills',              type: 'Lab',       credits: 1 },
    { code: 'EE201', name: 'Basic Electrical Engineering',                type: 'Theory',    credits: 3 },
    { code: 'MA201', name: 'Discrete Mathematics',                        type: 'Theory',    credits: 3 },
    { code: 'EC201', name: 'Electronic Devices',                          type: 'Theory',    credits: 3 },
    { code: 'EC201L', name: 'Electronic Devices Lab',                     type: 'Lab',       credits: 1 },
    { code: 'CS201', name: 'Object Oriented Programming through Java',    type: 'Theory',    credits: 3 },
    { code: 'CS201L', name: 'OOP Lab',                                    type: 'Lab',       credits: 1 },
  ],
  'ECE-R22-2-1': [
    { code: 'EC301', name: 'Signals & Systems',                           type: 'Theory',    credits: 3 },
    { code: 'EC302', name: 'Electromagnetic Theory',                      type: 'Theory',    credits: 3 },
    { code: 'EC303', name: 'Analog Electronic Circuits',                  type: 'Theory',    credits: 3 },
    { code: 'EC303L', name: 'Analog Circuits Lab',                        type: 'Lab',       credits: 1 },
    { code: 'EC304', name: 'Digital Electronics & Computer Organization', type: 'Theory',    credits: 3 },
    { code: 'MA301', name: 'Numerical Methods & Integral Transforms',     type: 'Theory',    credits: 3 },
    { code: 'CS301L', name: 'Python Lab',                                 type: 'Lab',       credits: 1 },
  ],
  'ECE-R22-2-2': [
    { code: 'EC401', name: 'Communications Engineering',                  type: 'Theory',    credits: 3 },
    { code: 'EC401L', name: 'Communications Lab',                         type: 'Lab',       credits: 1 },
    { code: 'EC402', name: 'Control Systems',                             type: 'Theory',    credits: 3 },
    { code: 'EC403', name: 'VLSI Design',                                 type: 'Theory',    credits: 3 },
    { code: 'EC404', name: 'Microprocessors & Microcontrollers',          type: 'Theory',    credits: 3 },
    { code: 'EC404L', name: 'Microprocessors Lab',                        type: 'Lab',       credits: 1 },
    { code: 'MA401', name: 'Probability & Stochastic Processes',          type: 'Theory',    credits: 3 },
  ],
  'ECE-R22-3-1': [
    { code: 'EC501', name: 'Digital Signal Processing',                   type: 'Theory',    credits: 3 },
    { code: 'EC501L', name: 'DSP Lab',                                    type: 'Lab',       credits: 1 },
    { code: 'CS501', name: 'Computer Networks',                           type: 'Theory',    credits: 3 },
    { code: 'EC502', name: 'Embedded Systems',                            type: 'Theory',    credits: 3 },
    { code: 'EC502L', name: 'Embedded Systems Lab',                       type: 'Lab',       credits: 1 },
    { code: 'EC503', name: 'Wireless & Mobile Communications',            type: 'Theory',    credits: 3 },
    { code: 'PE501', name: 'Elective-I',                                  type: 'Elective',  credits: 3 },
  ],
  'ECE-R22-3-2': [
    { code: 'EC601L', name: 'VLSI Design Lab',                            type: 'Lab',       credits: 1 },
    { code: 'EC601', name: 'IoT & Applications',                          type: 'Theory',    credits: 3 },
    { code: 'EC602', name: 'Antenna & Wave Propagation',                  type: 'Theory',    credits: 3 },
    { code: 'EC603', name: 'Digital Image Processing',                    type: 'Theory',    credits: 3 },
    { code: 'PE601', name: 'Elective-II',                                 type: 'Elective',  credits: 3 },
    { code: 'PE602', name: 'Elective-III',                                type: 'Elective',  credits: 3 },
    { code: 'MC601', name: 'Seminar',                                     type: 'Mandatory', credits: 2 },
  ],
  'ECE-R22-4-1': [
    { code: 'EC701', name: 'Optical Fiber Communications',                type: 'Theory',    credits: 3 },
    { code: 'PE701', name: 'Elective-IV',                                 type: 'Elective',  credits: 3 },
    { code: 'PE702', name: 'Elective-V',                                  type: 'Elective',  credits: 3 },
    { code: 'MC701', name: 'Environmental Science',                       type: 'Mandatory', credits: 2 },
    { code: 'MC702', name: 'Gender Sensitization',                        type: 'Mandatory', credits: 2 },
    { code: 'MC703', name: 'Constitution of India',                       type: 'Mandatory', credits: 2 },
  ],
  'ECE-R22-4-2': [
    { code: 'EC801', name: 'Project Work',                                type: 'Theory',    credits: 6 },
    { code: 'PE801', name: 'Elective-VI',                                 type: 'Elective',  credits: 3 },
  ],
  ...
  // ════════════════════════════════════════════
  'ECE-MLR20-1-1': [
    { code: 'MA101', name: 'Mathematics-I',                               type: 'Theory',    credits: 4 },
    ...
    { code: 'EN101', name: 'English',                                     type: 'Theory',    credits: 2 },
    { code: 'CS191', name: 'Programming Lab',                             type: 'Lab',       credits: 1 },
    { code: 'PH191', name: 'Physics Lab',                                 type: 'Lab',       credits: 1 },
    { code: 'ME191', name: 'Workshop',                                    type: 'Lab',       credits: 1 },
  ],
  'ECE-MLR20-1-2': [
    { code: 'MA102', name: 'Advanced Calculus',                           type: 'Theory',    credits: 4 },
    { code: 'CH101', name: 'Applied Chemistry',                           type: 'Theory',    credits: 4 },
    { code: 'EE101', name: 'Basic Electrical Engineering',                type: 'Theory',    credits: 3 },
    { code: 'EC201', name: 'Electronic Devices',                          type: 'Theory',    credits: 3 },
    { code: 'EN191', name: 'English Skills Lab',                          type: 'Lab',       credits: 1 },
    { code: 'CH191', name: 'Chemistry Lab',                               type: 'Lab',       credits: 1 },
    { code: 'EC291', name: 'Electronic Devices Lab',                      type: 'Lab',       credits: 1 },
  ],
  'ECE-MLR20-2-1': [
    { code: 'EC301', name: 'Signals & Systems',                           type: 'Theory',    credits: 3 },
    { code: 'EC302', name: 'Electromagnetic Theory',                      type: 'Theory',    credits: 3 },
    { code: 'EC303', name: 'Analog Electronic Circuits',                  type: 'Theory',    credits: 3 },
    { code: 'EC391', name: 'Analog Circuits Lab',                         type: 'Lab',       credits: 1 },
    { code: 'MA301', name: 'Discrete Mathematics',                        type: 'Theory',    credits: 3 },
    { code: 'EC304', name: 'Digital Electronics & Computer Organization', type: 'Theory',    credits: 3 },
    { code: 'CS391', name: 'Python Lab',                                  type: 'Lab',       credits: 1 },
  ],
  'ECE-MLR20-2-2': [
    { code: 'EC401', name: 'Communications Engineering',                  type: 'Theory',    credits: 3 },
    { code: 'EC491', name: 'Communications Lab',                          type: 'Lab',       credits: 1 },
    { code: 'EC402', name: 'Control Systems',                             type: 'Theory',    credits: 3 },
    { code: 'EC403', name: 'VLSI Design',                                 type: 'Theory',    credits: 3 },
    { code: 'EC404', name: 'Microprocessors',                             type: 'Theory',    credits: 3 },
    { code: 'EC492', name: 'Microprocessors Lab',                         type: 'Lab',       credits: 1 },
    { code: 'MA401', name: 'Probability & Statistics',                    type: 'Theory',    credits: 3 },
  ],
  'ECE-MLR20-3-1': [
    { code: 'EC501', name: 'Digital Signal Processing',                   type: 'Theory',    credits: 3 },
    { code: 'EC591', name: 'DSP Lab',                                     type: 'Lab',       credits: 1 },
    { code: 'CS501', name: 'Computer Networks',                           type: 'Theory',    credits: 3 },
    { code: 'EC502', name: 'Embedded Systems',                            type: 'Theory',    credits: 3 },
    { code: 'EC592', name: 'Embedded Lab',                                type: 'Lab',       credits: 1 },
    { code: 'EC503', name: 'Wireless Communications',                     type: 'Theory',    credits: 3 },
  ],
  'ECE-MLR20-3-2': [
    { code: 'EC601', name: 'IoT & Applications',                          type: 'Theory',    credits: 3 },
    { code: 'EC602', name: 'Antenna & Wave Propagation',                  type: 'Theory',    credits: 3 },
    { code: 'EC603', name: 'Digital Image Processing',                    type: 'Theory',    credits: 3 },
    { code: 'EC691', name: 'VLSI Lab',                                    type: 'Lab',       credits: 1 },
    { code: 'PE601', name: 'Elective',                                    type: 'Elective',  credits: 3 },
    { code: 'MC601', name: 'Seminar',                                     type: 'Mandatory', credits: 2 },
  ],
  ...
  'EEE-R22-1-1': [
    ...
    { code: 'ES101', name: 'Programming for Problem Solving',             type: 'Theory',    credits: 3 },
    { code: 'ES102', name: 'Engineering Drawing',                         type: 'Theory',    credits: 3 },
    { code: 'HS101L', name: 'English Skills Lab',                         type: 'Lab',       credits: 1 },
    { code: 'ES101L', name: 'Programming Lab',                            type: 'Lab',       credits: 1 },
    { code: 'BS102L', name: 'Physics Lab',                                type: 'Lab',       credits: 1 },
    { code: 'MC101', name: 'Mandatory Induction',                         type: 'Mandatory', credits: 0 },
  ],
  'EEE-R22-1-2': [
    { code: 'BS201', name: 'Engineering Chemistry',                       type: 'Theory',    credits: 4 },
    { code: 'HS201L', name: 'Communication Skills Lab',                   type: 'Lab',       credits: 1 },
    { code: 'EE201', name: 'Basic Electrical Engineering',                type: 'Theory',    credits: 3 },
    { code: 'MA201', name: 'Discrete Mathematics',                        type: 'Theory',    credits: 3 },
    { code: 'EC201', name: 'Electronic Devices',                          type: 'Theory',    credits: 3 },
    { code: 'EC201L', name: 'Electronic Devices Lab',                     type: 'Lab',       credits: 1 },
    { code: 'CS201', name: 'OOP through Java',                            type: 'Theory',    credits: 3 },
    { code: 'CS201L', name: 'OOP Lab',                                    type: 'Lab',       credits: 1 },
  ],
  'EEE-R22-2-1': [
    { code: 'EE301', name: 'Electrical Circuit Analysis',                 type: 'Theory',    credits: 3 },
    { code: 'EE302', name: 'Electromagnetic Theory',                      type: 'Theory',    credits: 3 },
    { code: 'EC301', name: 'Analog Electronic Circuits',                  type: 'Theory',    credits: 3 },
    { code: 'EC301L', name: 'Analog Circuits Lab',                        type: 'Lab',       credits: 1 },
    { code: 'EE303', name: 'Digital Electronics',                         type: 'Theory',    credits: 3 },
    { code: 'MA301', name: 'Numerical Methods & Integral Transforms',     type: 'Theory',    credits: 3 },
    { code: 'CS301L', name: 'Python Lab',                                 type: 'Lab',       credits: 1 },
  ],
  'EEE-R22-2-2': [
    { code: 'EE401', name: 'Electrical Machines-I',                       type: 'Theory',    credits: 3 },
    { code: 'EE491', name: 'Electrical Machines Lab-I',                   type: 'Lab',       credits: 1 },
    { code: 'EE402', name: 'Power Systems-I',                             type: 'Theory',    credits: 3 },
    { code: 'EE403', name: 'Control Systems',                             type: 'Theory',    credits: 3 },
    { code: 'EE404', name: 'Measurements & Instrumentation',              type: 'Theory',    credits: 3 },
    { code: 'EE492', name: 'Measurements Lab',                            type: 'Lab',       credits: 1 },
    { code: 'MA401', name: 'Probability & Statistics',                    type: 'Theory',    credits: 3 },
  ],
  'EEE-R22-3-1': [
    { code: 'EE501', name: 'Electrical Machines-II',                      type: 'Theory',    credits: 3 },
    { code: 'EE591', name: 'Electrical Machines Lab-II',                  type: 'Lab',       credits: 1 },
    { code: 'EE502', name: 'Power Systems-II',                            type: 'Theory',    credits: 3 },
    { code: 'EE503', name: 'Power Electronics',                           type: 'Theory',    credits: 3 },
    { code: 'EE592', name: 'Power Electronics Lab',                       type: 'Lab',       credits: 1 },
    { code: 'EC501', name: 'Signals & Systems',                           type: 'Theory',    credits: 3 },
    { code: 'PE501', name: 'Elective-I',                                  type: 'Elective',  credits: 3 },
  ],
  'EEE-R22-3-2': [
    { code: 'EE691', name: 'Power Systems Lab',                           type: 'Lab',       credits: 1 },
    { code: 'EE601', name: 'Drives & Control',                            type: 'Theory',    credits: 3 },
    { code: 'EE692', name: 'Drives Lab',                                  type: 'Lab',       credits: 1 },
    { code: 'EC601', name: 'Microprocessors',                             type: 'Theory',    credits: 3 },
    { code: 'EC691', name: 'Microprocessors Lab',                         type: 'Lab',       credits: 1 },
    { code: 'PE601', name: 'Elective-II',                                 type: 'Elective',  credits: 3 },
    { code: 'MC601', name: 'Seminar',                                     type: 'Mandatory', credits: 2 },
  ],
  'EEE-R22-4-1': [
    { code: 'EE701', name: 'Switchgear & Protection',                     type: 'Theory',    credits: 3 },
    { code: 'EE702', name: 'Renewable Energy Sources',                    type: 'Theory',    credits: 3 },
    { code: 'PE701', name: 'Elective-III',                                type: 'Elective',  credits: 3 },
    { code: 'PE702', name: 'Elective-IV',                                 type: 'Elective',  credits: 3 },
    { code: 'MC701', name: 'Environmental Science',                       type: 'Mandatory', credits: 2 },
    { code: 'MC702', name: 'Gender Sensitization',                        type: 'Mandatory', credits: 2 },
  ],
  'EEE-R22-4-2': [
    { code: 'EE801', name: 'Project Work',                                type: 'Theory',    credits: 6 },
    { code: 'PE801', name: 'Elective-V',                                  type: 'Elective',  credits: 3 },
  ],
  ...
  'EEE-MLR20-2-1': [
    ...
    { code: 'EE302', name: 'Electromagnetic Theory',                      type: 'Theory',    credits: 3 },
    { code: 'EC301', name: 'Analog Electronic Circuits',                  type: 'Theory',    credits: 3 },
    { code: 'EC391', name: 'Analog Lab',                                  type: 'Lab',       credits: 1 },
    { code: 'EE303', name: 'Digital Electronics',                         type: 'Theory',    credits: 3 },
    { code: 'MA301', name: 'Numerical Methods & Integral Transforms',     type: 'Theory',    credits: 3 },
    { code: 'CS391', name: 'Python Lab',                                  type: 'Lab',       credits: 1 },
  ],
  'EEE-MLR20-2-2': [
    ...
    { code: 'EE402', name: 'Power Systems-I',                             type: 'Theory',    credits: 3 },
    { code: 'EE403', name: 'Control Systems',                             type: 'Theory',    credits: 3 },
    { code: 'EE404', name: 'Measurements',                                type: 'Theory',    credits: 3 },
    { code: 'EE492', name: 'Measurements Lab',                            type: 'Lab',       credits: 1 },
    { code: 'MA401', name: 'Probability & Statistics',                    type: 'Theory',    credits: 3 },
  ],
  'EEE-MLR20-3-1': [
    { code: 'EE501', name: 'Electrical Machines-II',                      type: 'Theory',    credits: 3 },
    { code: 'EE591', name: 'Machines Lab-II',                             type: 'Lab',       credits: 1 },
    { code: 'EE502', name: 'Power Systems-II',                            type: 'Theory',    credits: 3 },
    { code: 'EE503', name: 'Power Electronics',                           type: 'Theory',    credits: 3 },
    { code: 'EE592', name: 'Power Electronics Lab',                       type: 'Lab',       credits: 1 },
    { code: 'EC501', name: 'Signals & Systems',                           type: 'Theory',    credits: 3 },
  ...
  'EEE-MLR18-1-1': [
    { code: 'MA101', name: 'Mathematics-I',                               type: 'Theory',    credits: 4 },
    { code: 'PH101', name: 'Applied Physics',                             type: 'Theory',    credits: 4 },
    { code: 'CS101', name: 'Engineering Exploration',                     type: 'Theory',    credits: 3 },
    { code: 'ME101', name: 'Engineering Graphics',                        type: 'Theory',    credits: 3 },
    { code: 'EN101', name: 'English',                                     type: 'Theory',    credits: 2 },
    { code: 'PH191', name: 'Physics Lab',                                 type: 'Lab',       credits: 1 },
    { code: 'ME191', name: 'Workshop',                                    type: 'Lab',       credits: 1 },
  ...
  'EEE-MLR18-1-2': [
    { code: 'MA102', name: 'Advanced Calculus',                           type: 'Theory',    credits: 4 },
    { code: 'CH101', name: 'Chemistry',                                   type: 'Theory',    credits: 4 },
    { code: 'EE101', name: 'Basic Electrical Engineering',                type: 'Theory',    credits: 3 },
    { code: 'EC201', name: 'Electronic Devices',                          type: 'Theory',    credits: 3 },
    { code: 'EN191', name: 'English Lab',                                 type: 'Lab',       credits: 1 },
    { code: 'CH191', name: 'Chemistry Lab',                               type: 'Lab',       credits: 1 },
    { code: 'EE191', name: 'Basic Electrical Engineering Lab',            type: 'Lab',       credits: 1 },
  ],
  'EEE-MLR18-2-1': [
    { code: 'EE301', name: 'Electrical Circuit Analysis',                 type: 'Theory',    credits: 3 },
    { code: 'EE302', name: 'Electromagnetic Theory',                      type: 'Theory',    credits: 3 },
    ...
    { code: 'EC391', name: 'Analog Lab',                                  type: 'Lab',       credits: 1 },
    { code: 'EE303', name: 'Digital Electronics',                         type: 'Theory',    credits: 3 },
    { code: 'CS301', name: 'Object-Oriented Programming',                 type: 'Theory',    credits: 3 },
    { code: 'CS391', name: 'OOP Lab',                                     type: 'Lab',       credits: 1 },
  ],
  'EEE-MLR18-2-2': [
    { code: 'EE401', name: 'Electrical Machines-I',                       type: 'Theory',    credits: 3 },
    { code: 'EE491', name: 'Machines Lab-I',                              type: 'Lab',       credits: 1 },
    { code: 'EE402', name: 'Power Systems-I',                             type: 'Theory',    credits: 3 },
    { code: 'EE403', name: 'Control Systems',                             type: 'Theory',    credits: 3 },
    { code: 'EE404', name: 'Measurements',                                type: 'Theory',    credits: 3 },
    { code: 'MA401', name: 'Probability & Statistics',                    type: 'Theory',    credits: 3 },
  ...
  'EEE-MLR18-3-1': [
    ...
    { code: 'EE503', name: 'Power Electronics',                           type: 'Theory',    credits: 3 },
    { code: 'EE592', name: 'Power Electronics Lab',                       type: 'Lab',       credits: 1 },
    { code: 'EC501', name: 'Microprocessors',                             type: 'Theory',    credits: 3 },
  ],
  'EEE-MLR18-3-2': [
    { code: 'EE691', name: 'Power Systems Lab',                           type: 'Lab',       credits: 1 },
    { code: 'EE601', name: 'Drives & Control',                            type: 'Theory',    credits: 3 },
    { code: 'EE692', name: 'Drives Lab',                                  type: 'Lab',       credits: 1 },
    { code: 'CS601', name: 'Big Data Analytics',                          type: 'Theory',    credits: 3 },
    { code: 'CS691', name: 'Big Data Lab',                                type: 'Lab',       credits: 1 },
    { code: 'MC601', name: 'Social Innovation',                           type: 'Mandatory', credits: 2 },
  ],
  ...
  'AIML-R22-1-2': [
    ...
    { code: 'EE201', name: 'Basic Electrical Engineering',                type: 'Theory',    credits: 3 },
    { code: 'MA201', name: 'Discrete Mathematics',                        type: 'Theory',    credits: 3 },
    { code: 'CS201', name: 'Data Structures',                             type: 'Theory',    credits: 3 },
    { code: 'CS201L', name: 'Data Structures Lab',                        type: 'Lab',       credits: 1 },
    { code: 'CS202', name: 'OOP through Java',                            type: 'Theory',    credits: 3 },
    { code: 'CS202L', name: 'OOP Lab',                                    type: 'Lab',       credits: 1 },
  ],
  'AIML-R22-2-1': [
    { code: 'CS301', name: 'Digital Electronics & Computer Organization', type: 'Theory',    credits: 3 },
    { code: 'MA301', name: 'Numerical Methods & Integral Transforms',     type: 'Theory',    credits: 3 },
    { code: 'AI301', name: 'Statistics for AI',                           type: 'Theory',    credits: 3 },
    { code: 'CS302', name: 'Database Management Systems',                 type: 'Theory',    credits: 3 },
    { code: 'CS391', name: 'DBMS Lab',                                    type: 'Lab',       credits: 1 },
    { code: 'CS303', name: 'Design & Analysis of Algorithms',             type: 'Theory',    credits: 3 },
    { code: 'CS392', name: 'Python Programming Lab',                      type: 'Lab',       credits: 1 },
  ],
  'AIML-R22-2-2': [
    { code: 'CS401', name: 'Operating Systems',                           type: 'Theory',    credits: 3 },
    { code: 'CS491', name: 'OS Lab',                                      type: 'Lab',       credits: 1 },
    { code: 'CS402', name: 'Computer Networks',                           type: 'Theory',    credits: 3 },
    { code: 'CS492', name: 'CN Lab',                                      type: 'Lab',       credits: 1 },
    { code: 'AI401', name: 'Machine Learning',                            type: 'Theory',    credits: 3 },
    { code: 'AI491', name: 'ML Lab',                                      type: 'Lab',       credits: 1 },
    { code: 'PE401', name: 'Introduction to IoT',                         type: 'Elective',  credits: 3 },
  ],
  'AIML-R22-3-1': [
    { code: 'AI501', name: 'Deep Learning',                               type: 'Theory',    credits: 3 },
    { code: 'AI591', name: 'Deep Learning Lab',                           type: 'Lab',       credits: 1 },
    { code: 'AI502', name: 'Natural Language Processing',                 type: 'Theory',    credits: 3 },
    { code: 'AI592', name: 'NLP Lab',                                     type: 'Lab',       credits: 1 },
    { code: 'AI503', name: 'Computer Vision',                             type: 'Theory',    credits: 3 },
    { code: 'PE501', name: 'Cloud Computing',                             type: 'Elective',  credits: 3 },
    { code: 'CS591', name: 'Cloud Lab',                                   type: 'Lab',       credits: 1 },
  ],
  'AIML-R22-3-2': [
    { code: 'AI601', name: 'Reinforcement Learning',                      type: 'Theory',    credits: 3 },
    { code: 'AI602', name: 'AI Ethics & Governance',                      type: 'Theory',    credits: 3 },
    { code: 'CS601', name: 'Big Data Analytics',                          type: 'Theory',    credits: 3 },
    { code: 'CS691', name: 'Big Data Lab',                                type: 'Lab',       credits: 1 },
    { code: 'PE601', name: 'Elective-II',                                 type: 'Elective',  credits: 3 },
    { code: 'MC601', name: 'Seminar',                                     type: 'Mandatory', credits: 2 },
  ...
  'AIML-R22-4-1': [
    { code: 'AI701', name: 'Generative AI',                               type: 'Theory',    credits: 3 },
    { code: 'PE701', name: 'AI for Healthcare',                           type: 'Elective',  credits: 3 },
    { code: 'PE702', name: 'Elective-III',                                type: 'Elective',  credits: 3 },
    { code: 'MC701', name: 'Environmental Science',                       type: 'Mandatory', credits: 2 },
    { code: 'MC702', name: 'Gender Sensitization',                        type: 'Mandatory', credits: 2 },
    { code: 'MC703', name: 'Constitution of India',                       type: 'Mandatory', credits: 2 },
  ],
  'AIML-R22-4-2': [
    { code: 'AI801', name: 'Project Work',                                type: 'Theory',    credits: 6 },
    { code: 'PE801', name: 'Elective-IV',                                 type: 'Elective',  credits: 3 },
  ],
  ...
  'AIML-MLR20-1-2': [
    { code: 'MA102', name: 'Advanced Calculus',                           type: 'Theory',    credits: 4 },
    { code: 'CH101', name: 'Applied Chemistry',                           type: 'Theory',    credits: 4 },
    { code: 'EE101', name: 'Basic Electrical & Electronics Engineering',  type: 'Theory',    credits: 3 },
    { code: 'CS201', name: 'Data Structures',                             type: 'Theory',    credits: 3 },
    { code: 'EN191', name: 'English Skills Lab',                          type: 'Lab',       credits: 1 },
    { code: 'CH191', name: 'Chemistry Lab',                               type: 'Lab',       credits: 1 },
    { code: 'CS291', name: 'DS Lab',                                      type: 'Lab',       credits: 1 },
  ],
  'AIML-MLR20-2-1': [
    { code: 'CS301', name: 'Digital Electronics & Computer Organization', type: 'Theory',    credits: 3 },
    { code: 'MA301', name: 'Discrete Mathematics',                        type: 'Theory',    credits: 3 },
    { code: 'CS302', name: 'Object-Oriented Programming',                 type: 'Theory',    credits: 3 },
    { code: 'CS303', name: 'Database Management Systems',                 type: 'Theory',    credits: 3 },
    { code: 'CS391', name: 'OOP Lab',                                     type: 'Lab',       credits: 1 },
    { code: 'CS392', name: 'DBMS Lab',                                    type: 'Lab',       credits: 1 },
    { code: 'CS393', name: 'Python Lab',                                  type: 'Lab',       credits: 1 },
  ],
  'AIML-MLR20-2-2': [
    { code: 'AI401', name: 'Machine Learning',                            type: 'Theory',    credits: 3 },
    { code: 'AI491', name: 'ML Lab',                                      type: 'Lab',       credits: 1 },
    { code: 'CS401', name: 'Computer Networks',                           type: 'Theory',    credits: 3 },
    { code: 'CS402', name: 'Operating Systems',                           type: 'Theory',    credits: 3 },
    { code: 'AI402', name: 'Statistics for AI',                           type: 'Theory',    credits: 3 },
    { code: 'MA401', name: 'Probability & Statistics',                    type: 'Theory',    credits: 3 },
  ],
  'AIML-MLR20-3-1': [
    { code: 'AI501', name: 'Deep Learning',                               type: 'Theory',    credits: 3 },
    ...
    { code: 'AI503', name: 'Computer Vision',                             type: 'Theory',    credits: 3 },
    { code: 'AI591', name: 'Deep Learning Lab',                           type: 'Lab',       credits: 1 },
    { code: 'CS501', name: 'Internet of Things',                          type: 'Theory',    credits: 3 },
    { code: 'CS502', name: 'Big Data Analytics',                          type: 'Theory',    credits: 3 },
  ],
  'AIML-MLR20-3-2': [
    { code: 'AI601', name: 'Reinforcement Learning',                      type: 'Theory',    credits: 3 },
    { code: 'CS601', name: 'Cloud Computing',                             type: 'Theory',    credits: 3 },
    { code: 'AI602', name: 'AI Ethics',                                   type: 'Theory',    credits: 3 },
    { code: 'CS691', name: 'Big Data Lab',                                type: 'Lab',       credits: 1 },
    { code: 'CS692', name: 'Cloud Lab',                                   type: 'Lab',       credits: 1 },
    { code: 'MC601', name: 'Seminar',                                     type: 'Mandatory', credits: 2 },
  ],
  ...
  'IT-R22-1-2': [
    { code: 'BS201', name: 'Engineering Chemistry',                       type: 'Theory',    credits: 4 },
    { code: 'HS201L', name: 'Communication Skills Lab',                   type: 'Lab',       credits: 1 },
    { code: 'EE201', name: 'Basic Electrical & Electronics Engineering',  type: 'Theory',    credits: 3 },
    { code: 'MA201', name: 'Discrete Mathematics',                        type: 'Theory',    credits: 3 },
    { code: 'CS201', name: 'Data Structures',                             type: 'Theory',    credits: 3 },
    { code: 'CS201L', name: 'DS Lab',                                     type: 'Lab',       credits: 1 },
    { code: 'CS202', name: 'OOP through Java',                            type: 'Theory',    credits: 3 },
    { code: 'CS202L', name: 'OOP Lab',                                    type: 'Lab',       credits: 1 },
  ],
  'IT-R22-2-1': [
    { code: 'CS301', name: 'Digital Electronics & Computer Organization', type: 'Theory',    credits: 3 },
    { code: 'MA301', name: 'Numerical Methods & Integral Transforms',     type: 'Theory',    credits: 3 },
    { code: 'MA302', name: 'Computer-Oriented Statistical Methods',       type: 'Theory',    credits: 3 },
    { code: 'CS302', name: 'Database Management Systems',                 type: 'Theory',    credits: 3 },
    { code: 'CS391', name: 'DBMS Lab',                                    type: 'Lab',       credits: 1 },
    { code: 'CS303', name: 'Design & Analysis of Algorithms',             type: 'Theory',    credits: 3 },
    { code: 'CS392', name: 'Python Lab',                                  type: 'Lab',       credits: 1 },
  ],
  'IT-R22-2-2': [
    { code: 'CS401', name: 'Operating Systems',                           type: 'Theory',    credits: 3 },
    { code: 'CS491', name: 'OS Lab',                                      type: 'Lab',       credits: 1 },
    { code: 'CS402', name: 'Computer Networks',                           type: 'Theory',    credits: 3 },
    { code: 'CS492', name: 'CN Lab',                                      type: 'Lab',       credits: 1 },
    { code: 'CS403', name: 'Automata & Compiler Design',                  type: 'Theory',    credits: 3 },
    { code: 'CS404', name: 'Software Engineering',                        type: 'Theory',    credits: 3 },
    { code: 'PE401', name: 'Internet of Things',                          type: 'Elective',  credits: 3 },
  ],
  'IT-R22-3-1': [
    { code: 'IT501', name: 'Information Security',                        type: 'Theory',    credits: 3 },
    { code: 'IT591', name: 'IS Lab',                                      type: 'Lab',       credits: 1 },
    { code: 'CS501', name: 'Data Mining & Machine Learning',              type: 'Theory',    credits: 3 },
    { code: 'CS591', name: 'DM Lab',                                      type: 'Lab',       credits: 1 },
    { code: 'PE501', name: 'Cloud & DevOps',                              type: 'Elective',  credits: 3 },
    { code: 'CS592', name: 'Cloud Lab',                                   type: 'Lab',       credits: 1 },
    { code: 'PE502', name: 'Introduction to AI',                          type: 'Elective',  credits: 3 },
  ],
  'IT-R22-3-2': [
    { code: 'CS601', name: 'Distributed Computing',                       type: 'Theory',    credits: 3 },
    { code: 'CS602', name: 'Software Testing',                            type: 'Theory',    credits: 3 },
    { code: 'CS603', name: 'Web Technologies',                            type: 'Theory',    credits: 3 },
    { code: 'CS691', name: 'Web Tech Lab',                                type: 'Lab',       credits: 1 },
    { code: 'MC601', name: 'Business Economics',                          type: 'Theory',    credits: 3 },
    { code: 'MC602', name: 'Human Values',                                type: 'Mandatory', credits: 2 },
  ],
  'IT-R22-4-1': [
    { code: 'EC701', name: 'Electronic Devices',                          type: 'Theory',    credits: 3 },
    { code: 'MC701', name: 'Environmental Science',                       type: 'Mandatory', credits: 2 },
    { code: 'MC702', name: 'Gender Sensitization',                        type: 'Mandatory', credits: 2 },
    { code: 'MC703', name: 'Constitution of India',                       type: 'Mandatory', credits: 2 },
    { code: 'MC704', name: 'Seminar',                                     type: 'Mandatory', credits: 2 },
  ],
  'IT-R22-4-2': [
    { code: 'IT801', name: 'Project Work',                                type: 'Theory',    credits: 6 },
    { code: 'PE801', name: 'Elective',                                    type: 'Elective',  credits: 3 },
  ],
  ...
  'IT-MLR20-2-2': [
    { code: 'CS401', name: 'Design & Analysis of Algorithms',             type: 'Theory',    credits: 3 },
    { code: 'CS402', name: 'Computer Networks',                           type: 'Theory',    credits: 3 },
    { code: 'AI401', name: 'Machine Learning',                            type: 'Theory',    credits: 3 },
    { code: 'AI491', name: 'ML Lab',                                      type: 'Lab',       credits: 1 },
    { code: 'CS403', name: 'Operating Systems',                           type: 'Theory',    credits: 3 },
    { code: 'MA401', name: 'Probability & Statistics',                    type: 'Theory',    credits: 3 },
  ],
  'IT-MLR20-3-1': [
    { code: 'CS501', name: 'Automata & Compiler Design',                  type: 'Theory',    credits: 3 },
    { code: 'CS502', name: 'Software Engineering',                        type: 'Theory',    credits: 3 },
    { code: 'CS503', name: 'Web Technologies',                            type: 'Theory',    credits: 3 },
    { code: 'CS591', name: 'Web Tech Lab',                                type: 'Lab',       credits: 1 },
    { code: 'CS592', name: 'Linux Lab',                                   type: 'Lab',       credits: 1 },
  ],
  'IT-MLR20-3-2': [
    { code: 'CS601', name: 'Big Data Analytics',                          type: 'Theory',    credits: 3 },
    { code: 'CS691', name: 'Big Data Lab',                                type: 'Lab',       credits: 1 },
    { code: 'CS602', name: 'Cloud Computing',                             type: 'Theory',    credits: 3 },
    { code: 'CS692', name: 'Cloud Lab',                                   type: 'Lab',       credits: 1 },
    { code: 'CS693', name: 'Network Simulation Lab',                      type: 'Lab',       credits: 1 },
    { code: 'MC601', name: 'Business Economics',                          type: 'Theory',    credits: 3 },
  ],
  ...
  'IT-MLR18-2-1': [
    { code: 'CS301', name: 'Digital Electronics & Computer Organization', type: 'Theory',    credits: 3 },
    { code: 'MA301', name: 'Discrete Structures',                         type: 'Theory',    credits: 3 },
    { code: 'CS302', name: 'Object-Oriented Programming',                 type: 'Theory',    credits: 3 },
    { code: 'CS303', name: 'Database Management Systems',                 type: 'Theory',    credits: 3 },
    { code: 'CS391', name: 'OOP Lab',                                     type: 'Lab',       credits: 1 },
    { code: 'CS392', name: 'DBMS Lab',                                    type: 'Lab',       credits: 1 },
    { code: 'EE191', name: 'BEEE Lab',                                    type: 'Lab',       credits: 1 },
  ],
  'IT-MLR18-2-2': [
    { code: 'CS401', name: 'Design & Analysis of Algorithms',             type: 'Theory',    credits: 3 },
    { code: 'CS402', name: 'Computer Networks',                           type: 'Theory',    credits: 3 },
    { code: 'EC401', name: 'Electronic Devices',                          type: 'Theory',    credits: 3 },
    { code: 'CS403', name: 'Computer Organization & Architecture',        type: 'Theory',    credits: 3 },
    { code: 'MA401', name: 'Probability & Statistics',                    type: 'Theory',    credits: 3 },
    { code: 'EC491', name: 'Electronic Devices Lab',                      type: 'Lab',       credits: 1 },
    { code: 'CS491', name: 'Network Simulation Lab',                      type: 'Lab',       credits: 1 },
  ],
  'IT-MLR18-3-1': [
    { code: 'CS501', name: 'Formal Languages & Automata',                 type: 'Theory',    credits: 3 },
    { code: 'CS502', name: 'Compiler Design',                             type: 'Theory',    credits: 3 },
    { code: 'CS503', name: 'Operating Systems',                           type: 'Theory',    credits: 3 },
    { code: 'CS504', name: 'Linux Programming',                           type: 'Theory',    credits: 3 },
    { code: 'CS591', name: 'Linux Lab',                                   type: 'Lab',       credits: 1 },
  ],
  'IT-MLR18-3-2': [
    { code: 'CS601', name: 'Big Data Analytics',                          type: 'Theory',    credits: 3 },
    { code: 'CS602', name: 'Web Technologies',                            type: 'Theory',    credits: 3 },
    { code: 'CS691', name: 'Big Data Lab',                                type: 'Lab',       credits: 1 },
    { code: 'CS692', name: 'Web Tech Lab',                                type: 'Lab',       credits: 1 },
    { code: 'MA601', name: 'Operations Research',                         type: 'Theory',    credits: 3 },
    { code: 'MC601', name: 'Social Innovation',                           type: 'Mandatory', credits: 2 },
  ],

  // ════════════════════════════════════════════
  // CSE-CS · R22 (Cyber Security)
  // ════════════════════════════════════════════
  'CSE-CS-R22-1-1': [
    { code: 'BS101', name: 'Mathematics-I',                               type: 'Theory',    credits: 4 },
    { code: 'BS102', name: 'Applied Physics',                             type: 'Theory',    credits: 4 },
  ...
  'CSE-CS-R22-3-1': [
    { code: 'CS501', name: 'Network Security',                            type: 'Theory',    credits: 3 },
    { code: 'CS591', name: 'Network Security Lab',                        type: 'Lab',       credits: 1 },
    { code: 'CS502', name: 'Cryptography',                                type: 'Theory',    credits: 3 },
    { code: 'CS592', name: 'Crypto Lab',                                  type: 'Lab',       credits: 1 },
    { code: 'CS503', name: 'Ethical Hacking',                             type: 'Theory',    credits: 3 },
    { code: 'PE501', name: 'Cloud Security',                              type: 'Elective',  credits: 3 },
    { code: 'CS593', name: 'Cloud Lab',                                   type: 'Lab',       credits: 1 },
  ],
  'CSE-CS-R22-3-2': [
    { code: 'CS601', name: 'Digital Forensics',                           type: 'Theory',    credits: 3 },
    { code: 'CS691', name: 'Forensics Lab',                               type: 'Lab',       credits: 1 },
    { code: 'CS602', name: 'Secure Software Development',                 type: 'Theory',    credits: 3 },
    { code: 'CS603', name: 'Malware Analysis',                            type: 'Theory',    credits: 3 },
    { code: 'PE601', name: 'Elective-II',                                 type: 'Elective',  credits: 3 },
    { code: 'MC601', name: 'Seminar',                                     type: 'Mandatory', credits: 2 },
  ],
  'CSE-CS-R22-4-1': [
    { code: 'CS701', name: 'Penetration Testing',                         type: 'Theory',    credits: 3 },
    { code: 'CS791', name: 'Pen Test Lab',                                type: 'Lab',       credits: 1 },
    { code: 'CS702', name: 'Security Operations',                         type: 'Theory',    credits: 3 },
    { code: 'PE701', name: 'Elective-III',                                type: 'Elective',  credits: 3 },
    { code: 'MC701', name: 'Environmental Science',                       type: 'Mandatory', credits: 2 },
    { code: 'MC702', name: 'Gender Sensitization',                        type: 'Mandatory', credits: 2 },
  ],
  'CSE-CS-R22-4-2': [
    { code: 'CS801', name: 'Project Work',                                type: 'Theory',    credits: 6 },
    { code: 'PE801', name: 'Elective-IV',                                 type: 'Elective',  credits: 3 },
  ],

  // ════════════════════════════════════════════
  // CSE-DS · R22 (Data Science)
  // ════════════════════════════════════════════
  'CSE-DS-R22-1-1': [
    { code: 'BS101', name: 'Mathematics-I',                               type: 'Theory',    credits: 4 },
    { code: 'BS102', name: 'Applied Physics',                             type: 'Theory',    credits: 4 },
  ...
  'CSE-DS-R22-2-1': [
    { code: 'CS301', name: 'Digital Electronics & Computer Organization', type: 'Theory',    credits: 3 },
    { code: 'MA301', name: 'Numerical Methods & Integral Transforms',     type: 'Theory',    credits: 3 },
    { code: 'DS301', name: 'Statistics for Data Science',                 type: 'Theory',    credits: 3 },
    { code: 'CS302', name: 'Database Management Systems',                 type: 'Theory',    credits: 3 },
    { code: 'CS391', name: 'DBMS Lab',                                    type: 'Lab',       credits: 1 },
    { code: 'CS303', name: 'Design & Analysis of Algorithms',             type: 'Theory',    credits: 3 },
    { code: 'CS392', name: 'Python Lab',                                  type: 'Lab',       credits: 1 },
  ...
  'CSE-DS-R22-2-2': [
    ...
    { code: 'AI401', name: 'Machine Learning',                            type: 'Theory',    credits: 3 },
    { code: 'AI491', name: 'ML Lab',                                      type: 'Lab',       credits: 1 },
    { code: 'PE401', name: 'Data Visualization',                          type: 'Elective',  credits: 3 },
  ],
  'CSE-DS-R22-3-1': [
    { code: 'AI501', name: 'Deep Learning',                               type: 'Theory',    credits: 3 },
    { code: 'AI591', name: 'Deep Learning Lab',                           type: 'Lab',       credits: 1 },
    { code: 'DS501', name: 'Big Data Analytics',                          type: 'Theory',    credits: 3 },
    { code: 'DS591', name: 'Big Data Lab',                                type: 'Lab',       credits: 1 },
    { code: 'DS502', name: 'Feature Engineering',                         type: 'Theory',    credits: 3 },
    { code: 'PE501', name: 'Cloud Computing',                             type: 'Elective',  credits: 3 },
    { code: 'CS591', name: 'Cloud Lab',                                   type: 'Lab',       credits: 1 },
  ],
  'CSE-DS-R22-3-2': [
    { code: 'DS601', name: 'Time Series Analysis',                        type: 'Theory',    credits: 3 },
    { code: 'AI601', name: 'Natural Language Processing',                 type: 'Theory',    credits: 3 },
    { code: 'DS602', name: 'Data Mining',                                 type: 'Theory',    credits: 3 },
    { code: 'DS691', name: 'Data Mining Lab',                             type: 'Lab',       credits: 1 },
    { code: 'PE601', name: 'Elective-II',                                 type: 'Elective',  credits: 3 },
    { code: 'MC601', name: 'Seminar',                                     type: 'Mandatory', credits: 2 },
  ],
  'CSE-DS-R22-4-1': [
    { code: 'DS701', name: 'Applied Data Science',                        type: 'Theory',    credits: 3 },
    { code: 'DS702', name: 'Business Intelligence',                       type: 'Theory',    credits: 3 },
    { code: 'PE701', name: 'Elective-III',                                type: 'Elective',  credits: 3 },
    { code: 'MC701', name: 'Environmental Science',                       type: 'Mandatory', credits: 2 },
    { code: 'MC702', name: 'Gender Sensitization',                        type: 'Mandatory', credits: 2 },
    { code: 'MC703', name: 'Constitution of India',                       type: 'Mandatory', credits: 2 },
  ...
  'CSE-DS-R22-4-2': [
    { code: 'DS801', name: 'Project Work',                                type: 'Theory',    credits: 6 },
    { code: 'PE801', name: 'Elective-IV',                                 type: 'Elective',  credits: 3 },
  ],
  ...
  'CSIT-R22-3-1': [
    { code: 'IT501', name: 'Information Security',                        type: 'Theory',    credits: 3 },
    { code: 'IT591', name: 'IS Lab',                                      type: 'Lab',       credits: 1 },
    { code: 'CS501', name: 'Cloud & DevOps',                              type: 'Theory',    credits: 3 },
    { code: 'CS591', name: 'Cloud Lab',                                   type: 'Lab',       credits: 1 },
    { code: 'CS502', name: 'Data Mining',                                 type: 'Theory',    credits: 3 },
    { code: 'CS592', name: 'Data Mining Lab',                             type: 'Lab',       credits: 1 },
    { code: 'PE501', name: 'Introduction to AI',                          type: 'Elective',  credits: 3 },
  ],
  'CSIT-R22-3-2': [
    { code: 'CS601', name: 'Distributed Systems',                         type: 'Theory',    credits: 3 },
    { code: 'CS602', name: 'Web Technologies',                            type: 'Theory',    credits: 3 },
    { code: 'CS691', name: 'Web Tech Lab',                                type: 'Lab',       credits: 1 },
    { code: 'CS603', name: 'Software Testing',                            type: 'Theory',    credits: 3 },
    { code: 'MC601', name: 'Business Economics',                          type: 'Theory',    credits: 3 },
    { code: 'MC602', name: 'Human Values',                                type: 'Mandatory', credits: 2 },
  ],
  'CSIT-R22-4-1': [
  ...
  'AERO-MLR18-1-2': [
    ...
    { code: 'CH101', name: 'Chemistry',                                   type: 'Theory',    credits: 4 },
    { code: 'EE101', name: 'Basic Electrical Engineering',                type: 'Theory',    credits: 3 },
    { code: 'AE201', name: 'Aeronautical Engineering Fundamentals',       type: 'Theory',    credits: 3 },
    { code: 'EN191', name: 'English Lab',                                 type: 'Lab',       credits: 1 },
    { code: 'CH191', name: 'Chemistry Lab',                               type: 'Lab',       credits: 1 },
  ],
  'AERO-MLR18-2-1': [
    { code: 'ME301', name: 'Solid Mechanics',                             type: 'Theory',    credits: 3 },
    { code: 'AE301', name: 'Aerodynamics-I',                              type: 'Theory',    credits: 3 },
    { code: 'MA301', name: 'Numerical Methods',                           type: 'Theory',    credits: 3 },
    { code: 'CS391', name: 'Python Lab',                                  type: 'Lab',       credits: 1 },
    { code: 'AE391', name: 'Aerodynamics Lab',                            type: 'Lab',       credits: 1 },
    { code: 'ME302', name: 'Thermodynamics',                              type: 'Theory',    credits: 3 },
  ],
  'AERO-MLR18-2-2': [
    { code: 'AE401', name: 'Aerospace Propulsion',                        type: 'Theory',    credits: 3 },
    { code: 'AE402', name: 'Aerospace Structures',                        type: 'Theory',    credits: 3 },
    { code: 'AE403', name: 'Flight Mechanics',                            type: 'Theory',    credits: 3 },
    { code: 'AE491', name: 'Aerospace Structures Lab',                    type: 'Lab',       credits: 1 },
    { code: 'MA401', name: 'Probability & Statistics',                    type: 'Theory',    credits: 3 },
  ],
};
