...
export default function NotificationsPage() {
  return (
    <>
      ...
      <section id="notifications" className="bg-warm-light min-h-[60vh] py-8 md:py-14">
        <div className="w-full px-4 md:px-10 lg:px-12">
          ...
          <Reveal preset="up" delay={0.2}>
            <div className="mt-6 p-4 md:mt-8 md:p-5 rounded-xl border border-border bg-white flex items-start gap-3">
