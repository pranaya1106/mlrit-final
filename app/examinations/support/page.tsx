...
export const metadata: Metadata = {
  title: 'Examinations Support — MLRIT',
...
export default function ExaminationsSupportPage() {
  return (
    <>
      <PageHeader
        variant="green"
        eyebrow="Examinations Support"
        title="Controller of"
        italic="Examinations."
      ...
      />
      <ExaminationsQuickNav active="/examinations/support" />
