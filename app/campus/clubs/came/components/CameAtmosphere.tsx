...
export default function CameAtmosphere({ containerRef: _unused }: Props) {
      ...
      >
        ...
        >
          ...
          <div
            ...
            style={{
              background:   'radial-gradient(ellipse 80% 70% at 50% 50%, rgba(245,118,10,0.26) 0%, rgba(160,30,10,0.16) 55%, transparent 75%)',
              mixBlendMode: 'screen',
            }}
          />
        </motion.div>
