...
export default function CameGlow({ endRef }: Props) {
  ...
  const leftGlow  = 'radial-gradient(ellipse 100% 70% at 0% 50%, rgba(245,118,10,0.36) 0%, rgba(180,40,10,0.14) 55%, transparent 80%)';
  const rightGlow = 'radial-gradient(ellipse 100% 70% at 100% 50%, rgba(245,118,10,0.36) 0%, rgba(180,40,10,0.14) 55%, transparent 80%)';
