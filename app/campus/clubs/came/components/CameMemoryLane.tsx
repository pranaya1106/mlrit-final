...
// ─── Asset config ─────────────────────────────────────────────────────────────
// Same mock memoryLane entries as lib/clubs.ts's `came` club — real event-specific
// photos haven't been supplied for CAME yet, so these are the placeholder shots
// used elsewhere on the site until real ones land.
const MEMORIES = [
  { src: '/images/students/club-event.png',      label: 'On Stage',       caption: 'A CAME cultural performance.',             category: 'Performance', rotation: -3,   oy: 8  },
  { src: '/images/students/p1.png',               label: 'Stage Lights',   caption: 'Students at a CAME stage performance.',    category: 'Performance', rotation: 2.5,  oy: -6 },
  { src: '/images/students/p2.png',               label: 'The Moment',     caption: 'A CAME cultural event moment.',            category: 'Fest',        rotation: -1.5, oy: 10 },
  { src: '/images/students/students-laughing.png', label: 'Backstage',      caption: 'CAME members bonding on campus.',          category: 'Community',   rotation: 3,    oy: -4 },
  { src: '/images/campus/canteen-friends.png',     label: 'Between Acts',   caption: 'Friends at the campus canteen.',           category: 'Community',   rotation: -2,   oy: 6  },
  { src: '/images/students/p3.png',                label: 'Fest Night',     caption: 'A CAME fest performance.',                 category: 'Fest',        rotation: 1.5,  oy: -10 },
  { src: '/images/students/campus-group.png',      label: 'The Crew',       caption: 'CAME club group photo.',                   category: 'Community',   rotation: -2.5, oy: 7  },
  { src: '/images/students/campus-steps.png',      label: 'Campus Steps',   caption: 'Students on campus steps.',                category: 'Community',   rotation: 2,    oy: -8 },
] as const;
...
// ─── Main ─────────────────────────────────────────────────────────────────────
export default function CameMemoryLane() {
