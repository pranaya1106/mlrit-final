...
// ─── Asset config ─────────────────────────────────────────────────────────────
// Same mock memoryLane entries as lib/clubs.ts's `code` club — real club
// photos haven't been supplied yet, so these are the placeholder shots used
// elsewhere on the site until real ones land.
const MEMORIES = [
  { src: '/images/students/faculty-seminar.png',          label: 'In Session',    caption: 'A CODE Club session in progress.',         category: 'Session',    rotation: -3,   oy: 8  },
  { src: '/images/students/reel-cse.png',                  label: 'CSE Coding',    caption: 'CSE students at a coding session.',        category: 'Session',    rotation: 2.5,  oy: -6 },
  { src: '/images/students/classroom-chat.png',            label: 'Talking It Out', caption: 'Students in a technical discussion.',     category: 'Discussion', rotation: -1.5, oy: 10 },
  { src: '/images/facilities/campus/library-wide-1.jpg',   label: 'The Library',   caption: 'Campus library.',                          category: 'Workspace',  rotation: 3,    oy: -4 },
  { src: '/images/students/lecture-hall.png',               label: 'Lecture Hall',  caption: 'A lecture hall session.',                  category: 'Session',    rotation: -2,   oy: 6  },
  { src: '/images/students/students-laughing.png',         label: 'Between Sets',  caption: 'Students bonding on campus.',              category: 'Community',  rotation: 1.5,  oy: -10 },
  { src: '/images/students/campus-group.png',              label: 'The Club',      caption: 'A CODE Club group photo.',                 category: 'Community',  rotation: -2.5, oy: 7  },
  { src: '/images/students/club-event.png',                label: 'On Campus',     caption: 'Students at a club event.',                category: 'Event',      rotation: 2,    oy: -8 },
] as const;
...
// ─── Main ─────────────────────────────────────────────────────────────────────
export default function CodeMemoryLane() {
