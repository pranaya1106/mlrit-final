...
export default function CodeAtmosphere({ containerRef: _unused }: Props) {
      ...
      >
        ...
        >
          ...
          <div
            ...
            style={{
              background:   'radial-gradient(ellipse 80% 70% at 50% 50%, rgba(61,220,90,0.24) 0%, rgba(10,50,20,0.16) 55%, transparent 75%)',
              mixBlendMode: 'screen',
            }}
          />
        </motion.div>
