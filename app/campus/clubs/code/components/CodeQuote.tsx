...
// Drawn from CODE's own "what" — the bookend that defines the whole club.
const QUOTE = 'From your first Hello, World to your final system design interview.';
...
export default function CodeQuote() {
  ...
  return (
    <section
      ...
      aria-label="CODE Club quotation"
    >
