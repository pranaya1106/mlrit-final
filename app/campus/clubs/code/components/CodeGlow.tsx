...
export default function CodeGlow({ endRef }: Props) {
  ...
  const leftGlow  = 'radial-gradient(ellipse 100% 70% at 0% 50%, rgba(61,220,90,0.34) 0%, rgba(10,80,30,0.13) 55%, transparent 80%)';
  const rightGlow = 'radial-gradient(ellipse 100% 70% at 100% 50%, rgba(61,220,90,0.34) 0%, rgba(10,80,30,0.13) 55%, transparent 80%)';
