...
export default function ScopeAtmosphere({ containerRef: _unused }: Props) {
      ...
      >
        ...
        >
          ...
          <div
            ...
            style={{
              background:   'radial-gradient(ellipse 80% 70% at 50% 50%, rgba(0,140,190,0.26) 0%, rgba(90,30,160,0.14) 55%, transparent 75%)',
              mixBlendMode: 'screen',
            }}
          />
        </motion.div>
