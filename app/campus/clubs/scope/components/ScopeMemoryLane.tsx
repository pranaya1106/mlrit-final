...
// ─── Asset config ─────────────────────────────────────────────────────────────
const MEMORIES = [
  { src: '/images/clubs/memory/zenith-25-entrance-arch.jpg', label: 'Entrance Arch',   caption: "Zenith'25 entrance arch, decorated for SCOPE's flagship fest.", category: 'Fest',        rotation: -3,   oy: 8  },
  { src: '/images/clubs/memory/zenith-25-registration.jpg',  label: 'Registration',    caption: 'Students registering at the Zenith\'25 help desk.',            category: 'Check-In',    rotation: 2.5,  oy: -6 },
  { src: '/images/clubs/memory/zenith-25-auditorium.jpg',    label: 'Auditorium',      caption: "Students filling the auditorium for Zenith'25.",               category: 'Community',   rotation: -1.5, oy: 10 },
  { src: '/images/clubs/memory/zenith-25-qa-session.jpg',    label: 'Discussion Panel', caption: "A student asking a question during a Zenith'25 panel.",       category: 'Panel',       rotation: 3,    oy: -4 },
  { src: '/images/clubs/memory/zenith-25-hackathon-lab.jpg', label: 'Hackathon Lab',   caption: "Participants coding during the Zenith'25 hackathon.",          category: 'Hackathon',   rotation: -2,   oy: 6  },
  { src: '/images/clubs/memory/zenith-25-lab-wide.jpg',      label: 'Lab, Wide Shot',  caption: 'A wide view of the hackathon lab in full swing.',              category: 'Hackathon',   rotation: 1.5,  oy: -10 },
  { src: '/images/clubs/memory/zenith-25-mentor-round.jpg',  label: 'Mentor Round',    caption: "A mentor reviewing a team's project during the hackathon.",    category: 'Mentorship',  rotation: -2.5, oy: 7  },
  { src: '/images/clubs/memory/zenith-25-speaker-qa.jpg',    label: 'Speaker Q&A',     caption: 'A student speaking into a mic during a Q&A session.',          category: 'Panel',       rotation: 2,    oy: -8 },
  { src: '/images/clubs/memory/zenith-25-award-ceremony.jpg', label: 'Award Ceremony', caption: "Winners being congratulated on stage at Zenith'25.",           category: 'Awards',      rotation: -1,   oy: 5  },
  { src: '/images/clubs/memory/zenith-25-group-photo.jpg',   label: 'Group Photo',     caption: "Participants posing with certificates after Zenith'25.",       category: 'Community',   rotation: 1.5,  oy: -6 },
] as const;
...
// ─── Main ─────────────────────────────────────────────────────────────────────
export default function ScopeMemoryLane() {
