...
const EVENTS = [
  {
    ...
    caption: 'A two-day Unity intensive. Industry mentors on day one — teams shipped full games from scratch on day two.',
  ...
  },
  {
    ...
    name:    'GENESIS',
    kind:    'Workshop · Gameathon',
    caption: 'Full event highlights reel.',
  ...
  },
  {
    ...
    caption: "MLRIT's first Valorant Campus Championship, hosted at Wild Gaming Cafe.",
  ...
  },
  {
    ...
    caption: 'Regular LAN nights open to the full campus — casual play, new friendships.',
    src:     '/images/clubs/apex/gallery/1.jpg',
    type:    'image' as const,
  },
  {
    slug:    'lan-vid',
    name:    'LAN Nights',
    kind:    'Community · Casual',
    caption: 'LAN night atmosphere.',
    src:     '/videos/apex-lan.mp4',
