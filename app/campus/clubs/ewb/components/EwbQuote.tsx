...
// The chapter's own official tagline.
const QUOTE = 'Engineering Ideas. Empowering Communities. Creating Change.';

export default function EwbQuote() {
  ...
  return (
    <section
      ...
      aria-label="EWB-IUCEE-IEEE quotation"
    >
      ...
      <div className="max-w-[1100px] mx-auto text-center">
        ...
        <div className="overflow-hidden">
          <motion.blockquote
            ...
            style={{ fontSize: 'clamp(1.7rem, 4.6vw, 3.8rem)' }}
          >
            &ldquo;{QUOTE}&rdquo;
          </motion.blockquote>
        </div>
