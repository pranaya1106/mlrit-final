...
export default function EwbGlow({ endRef }: Props) {
  ...
  const leftGlow  = 'radial-gradient(ellipse 100% 70% at 0% 50%, rgba(63,174,92,0.34) 0%, rgba(20,90,45,0.13) 55%, transparent 80%)';
  const rightGlow = 'radial-gradient(ellipse 100% 70% at 100% 50%, rgba(63,174,92,0.34) 0%, rgba(20,90,45,0.13) 55%, transparent 80%)';
