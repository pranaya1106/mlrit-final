    ...
    <>
      ...
      <div className="lg:flex lg:gap-0 items-start">
        ...
        <div className="flex-1 min-w-0">
          ...
          <section id="vision" className="bg-white py-8 md:py-14">
          ...
          <section id="mission" className="bg-white pb-12 md:pb-28">
            <div className="w-full px-6 md:px-10 lg:px-12 space-y-10">
                  ...
                  <ul className="mt-6 space-y-3 md:space-y-5">
                    {[
                      ...
                      <li key={i} className="flex items-start gap-3 md:gap-5">
                        ...
                        <p className="text-foreground leading-relaxed text-[0.92rem] md:text-[1.05rem]">{m}</p>
                      </li>
                    ))}
                  </ul>
                </div>
          ...
          <section id="values" className="bg-white pb-12 md:pb-28">
            <div className="w-full px-6 md:px-10 lg:px-12 space-y-10">
