...
const SCHOLARSHIPS = [
  {
    ...
    eligibility: 'Students who have represented at state, national or international level in any recognised sport. Valid participation/achievement certificate from a recognised sports authority required.',
    benefit: 'Partial to full tuition fee waiver based on level of achievement — state, national or international representation.',
    amount: 'Up to full tuition fee',
    howToApply: 'Submit achievement certificates, recommendation from sports authority and scholarship application form to the Dean of Student Affairs at the time of admission.',
  },
  {
    id: 'industry',
    badge: 'Industry / External',
    title: 'Industry & External Scholarships',
    color: 'border-primary/30 bg-orange-50/40',
    badgeColor: 'bg-orange-50 border-orange-200 text-primary',
    eligibility: 'MLRIT has an active MoU with Cybage Khushboo Charitable Trust offering 15 scholarships per year to B.Tech students. Family income below ₹4 lakh per annum. 60%+ in Class 10, Intermediate or Diploma.',
    benefit: 'Full or partial fee support as defined by the industry partner or charitable trust. Renewable annually based on academic performance.',
    amount: 'As per scheme',
    howToApply: 'Apply through the respective trust/partner portal (e.g. cybagekhushboo.org). Submit mark sheets, income certificate, caste certificate and bank details.',
  },
  {
    id: 'scst',
    badge: 'SC / ST / EWS',
    title: 'SC / ST / EWS Fee Reimbursement',
    color: 'border-secondary/30 bg-green-50/40',
    badgeColor: 'bg-green-50 border-green-200 text-secondary',
    eligibility: 'Students belonging to Scheduled Caste, Scheduled Tribe or Economically Weaker Section categories. Valid caste/EWS certificate from competent authority. Family income as per state government norms.',
    benefit: 'Full tuition fee reimbursement under AP/TS state government ePass scheme. Applicable for Convener quota seats.',
    amount: 'Full tuition fee (state scheme)',
    howToApply: 'Apply through AP ePass / TS ePass portal after admission. Submit caste/EWS certificate, income certificate and bank account details.',
  },
];
