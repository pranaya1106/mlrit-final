...
import { RECRUITERS, MOUS, type RecruiterLogo } from '@/lib/placements';
...
/**
 * Presentation only. Split from page.tsx because this file uses styled-jsx,
 * which forces a Client Component — so the CMS read has to happen in a server
 * parent and arrive as a prop.
 */
export default function RecruitersPage({ logos }: { logos: RecruiterLogo[] }) {
  return (
    <>
      {/* Recruiters */}
